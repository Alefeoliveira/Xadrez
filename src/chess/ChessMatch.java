...
public class ChessMatch {
	...
	private ChessPiece enPassantVurenable;
	...
	public ChessPiece getEnPassantVurenable() {
		return enPassantVurenable;
	}
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		if (movedPiece instanceof Pawn
			...
			enPassantVurenable = movedPiece;
		} else {
			enPassantVurenable = null;
		}
	...
	private void undoMovie(Position source, Position target, Piece capturedPiece) {
		...
		// #specialmove en passant
		if (p instanceof Pawn) {
			if (source.getColumn() != target.getColumn() && capturedPiece == enPassantVurenable) {
	...
	private void validateSourcePosition(Position pos) {
		...
		if (!board.piece(pos).isThereAnyPossibleMove()) {
			throw new ChessException("There is no possible moviments for the piece u trying to move");
		}
	}

	private void validateTargetPosition(Position source, Position target) {
		if (!board.piece(source).possibleMove(target)) {
			throw new ChessException("The chosen piece cant move for the target position");
		}
	}
